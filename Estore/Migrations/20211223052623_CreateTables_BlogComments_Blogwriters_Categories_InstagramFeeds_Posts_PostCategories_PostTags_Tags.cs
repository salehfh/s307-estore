...
{
    public partial class CreateTables_BlogComments_Blogwriters_Categories_InstagramFeeds_Posts_PostCategories_PostTags_Tags : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InstagramFeeds", x => x.Id);
                });
